    ...
    <section id="vision" className="section-padding relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight mb-4 sm:mb-6">
        ...
        <div className="grid grid-cols-3 gap-3 sm:gap-8">
          {[
            ...
            <motion.div
              ...
              className="bg-card-gradient border border-border/50 rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-card"
            >
              <item.icon className="text-primary mx-auto mb-2 sm:mb-4" size={22} />
              <p className="font-display text-xl sm:text-3xl font-bold text-gradient mb-1">{item.stat}</p>
              <p className="text-muted-foreground text-[10px] sm:text-sm">{item.label}</p>
            </motion.div>
          ))}
        </div>
      </div>
